...
import { DashboardsConfig, DashboardConfig, DashboardLocaleConfig } from "../common/dashboards-config.js";
...
var PRODUCTION_DASHBOARDS_CONFIG = new DashboardsConfig([
    new DashboardConfig("Account Dashboard", // TODO: Transition host app away from "sales_dashboard" to "account_dashboard", then remove "sales_dashboard".
    [
        "sales_dashboard",
        "account_dashboard",
        ...
        new DashboardLocaleConfig({
            /* "nl_BE" in src/translations/locales */ locales: [
                "nl-be",
                "nl_be"
            ],
        ...
        new DashboardLocaleConfig({
            /* "nl_NL" in src/translations/locales */ locales: [
                "nl",
                "nl-nl",
                "nl_nl"
            ],
    ...
    new DashboardConfig("Mobile Dashboard", [
        "mobile_dashboard",
        "Mobile_Dashboard_template_27.yaml"
    ], [
        new DashboardLocaleConfig({
            locales: [
                "da"
    ...
    new DashboardConfig("Onsite Dashboard", [
        "onsite_dashboard",
        "Onsite_Dashboard_template_44.yaml"
    ], [
        new DashboardLocaleConfig({
            locales: [
                "da"
...
var STAGING_DASHBOARDS_CONFIG = new DashboardsConfig([
    new DashboardConfig("Account Dashboard", // TODO: Transition host app away from "sales_dashboard" to "account_dashboard", then remove "sales_dashboard".
    [
        "sales_dashboard",
        "account_dashboard",
...
var DEVELOPMENT_DASHBOARDS_CONFIG = new DashboardsConfig([
    new DashboardConfig("Account Dashboard", [
        "sales_dashboard",
        "account_dashboard",
        "Account_Dashboard_template_14.yaml"
    ], [
...
export var DashboardsConfigMap = /*#__PURE__*/ function() {
    "use strict";
    function DashboardsConfigMap() {
        _class_call_check(this, DashboardsConfigMap);
    }
    _create_class(DashboardsConfigMap, [
        {
            key: "getDashboardLocaleConfig",
            value: function getDashboardLocaleConfig(dashboardId, locale, defaultToEn) {
                // Use either the development or production config.
                var dashboardsConfig = PRODUCTION_DASHBOARDS_CONFIG;
