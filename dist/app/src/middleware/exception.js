...
export default function exceptionMiddleware(call, context) {
    return _exceptionMiddleware.apply(this, arguments);
}
function _exceptionMiddleware() {
    _exceptionMiddleware = _wrap_async_generator(function(call, context) {
        var error;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        5,
                        _ts_values(_async_generator_delegate(_async_iterator(call.next(call.request, context)), _await_async_generator))
                    ];
                case 1:
                    return [
                        2,
                ...
                case 2:
                    ...
                    if (Config.USING_SENTRY && !_instanceof(error, ServerError)) {
